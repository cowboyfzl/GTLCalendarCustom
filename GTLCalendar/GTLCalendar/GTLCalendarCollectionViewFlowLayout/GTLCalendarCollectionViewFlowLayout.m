...
- (void)caculateContentSizeHeight {
    ...
    self.height = (rowCount * self.itemHeight) + (numberOfSections * self.headerHeight) + (self.minimumLineSpacing * lineSpacingCount) + (self.sectionInset.top * numberOfSections);
}
